ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :profiles do |profiles|
    profiles.resources :views
  end
  ...
  map.edit_from_document 'profiles/:id/edit_from_document', :controller => :profiles, :action => :edit_from_document 
  map.update_from_document 'profiles/:id/update_from_document', :controller => :profiles, :action => :update_from_document 
